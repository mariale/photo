...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
    ...
    <body style="background-image: url('img/img.jpg'); background-size: cover;">
       <header class="" style="background: rgba(6, 6, 6, 0.8); height: 118px;">
        ...
        <div class="row">
        <div class="col-mx-6 col-md-6 col-lg-6 col-md-push-6 col-mx-push-6 col-lg-push-6 " > 
            <div class="" style="background: rgb(18, 18, 19); padding: 20px; margin: 30px; border-radius: 0px; box-shadow: 1px 1px 2px #000">
                <div id="makeMeScrollable" style="height: 100%;">
                    <img src="img/fot1.png" width="100%" id="img_1">
                </div>
                <br>
                <div><p style="color:#FFF">View the photos of their excursions. Share them on social network of your choice. Download them to you device. <a href="registro.php" style="cursor: pointer;">CREATE YOUR ACCOUNT</a></p></div>
            </div>
        </div> 
        </div>
    </body>
